...
public abstract class HelperBaseCh4 {
    ...
    protected abstract void copyFromSession(Object sessionHelperObject);
    
    public void addHelperToSession(String name, SessionData sessionData) {
        if (SessionData.READ == sessionData) {
            Object sessionObject = request.getSession().getAttribute(name);
            
            if (sessionObject != null) {
                copyFromSession(sessionObject);
            }
        }
